$(document).ready(function () {
  ...
  gsap.set(".anime-card-front img", {
    attr: { src: "https://cdn.pixabay.com/photo/2021/08/04/13/06/software-developer-6521720_640.jpg" }
  });
  gsap.set(".anime-card-back img", {
    attr: { src:"https://e0.pxfuel.com/wallpapers/822/771/desktop-wallpaper-big-data-analytics-background-big-floral-big-badass-and-big-data-analysis.jpg" }
  });
  ...
  gsap.to(".anime-card-front img-fluid tanjiro", {
    attr: {src: "https://www.turing.com/blog/wp-content/uploads/2022/08/9-Best-Forums-for-Developers-to-Join-scaled.jpg"},
    scrollTrigger: {
      trigger: ".banner-three",
      start: "top bottom",
      end: "top bottom",
  ...
  gsap.to(".anime-card-back img", {
    attr: { src: "https://cdn.jotfor.ms/p/developers/images/developers-banner.png" },
    scrollTrigger: {
      trigger: ".banner-four",
      start: "top bottom",
      end: "top bottom",
